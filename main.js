...
const threeBlock = [
    {x: 2, y: 0}, {x: 2, y: 2}, //Three Block A
    {x: 3, y: 0}, {x: 3, y: 2}];//Three Block B
const twoBlock = [
    {x: 4, y: 1}, {x: 4, y: 2}, //Two Block A
    {x: 5, y: 1}, {x: 5, y: 2}, //Two Block B
    {x: 0, y: 3}, {x: 0, y: 4}, //Two Block C
    {x: 1, y: 3}, {x: 1, y: 4}, //Two Block D
    {x: 5, y: 3}, {x: 5, y: 4}];//Two Block E
const horiTwoBlock = [
    {x: 2, y: 4}, {x: 3, y: 4}, //Hori Block A
    {x: 1, y: 5}, {x: 2, y: 5}];//Hori Block B
const blocks = [
    {x: 2, y: 0}, {x: 2, y: 1}, {x: 2, y: 2}, //Three Block A Collision
    {x: 3, y: 0}, {x: 3, y: 1}, {x: 3, y: 2}, //Three Block B Collision
    {x: 4, y: 1}, {x: 4, y: 2}, //Two Block A Collision
    {x: 5, y: 1}, {x: 5, y: 2}, //Two Block B Collision
    {x: 0, y: 3}, {x: 0, y: 4}, //Two Block C Collision
    {x: 1, y: 3}, {x: 1, y: 4}, //Two Block D Collision
    {x: 5, y: 3}, {x: 5, y: 4}, //Two Block E Collision
    {x: 2, y: 4}, {x: 3, y: 4}, //Hori Block A Collision
    {x: 1, y: 5}, {x: 2, y: 5}, //Hori Block B Collision
    {x: 0, y: 2}, {x: 1, y: 2}];//Main Block Collision
//RENDERS VERTICAL THREE BLOCKS
const render3 = () => {
...
const winMessage = () => {
    ...
    winMessageElement.innerHTML = 'You Got Out!';
    document.querySelector('#container').appendChild(winMessageElement);
  };


//THIS FUNCTION ADDS A CLICK EVENT LISTENER TO EACH BLOCK
//AND MOVES THE BLOCK A SPECIFIC DIRECTION WHEN CLICKED
...
//THIS IS THE START OF ALL THE BLOCK MOVEMENT FUNCTIONS
//EACH ONE IS THE SAME CODE PERSONALISED FOR EACH BLOCK
